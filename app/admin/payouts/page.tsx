...
export default function AdminPayoutsPage() {
  ...
  const loadPayouts = async () => {
    try {
      ...
      console.log('Admin Payout API - Response status:', response.status)
      const data = await response.json()
      console.log('Admin Payout API - Response data:', data)
      
      if (data.success) {
        setPayouts(data.data)
        setStats(data.stats)
        console.log('Admin Payout API - Data set:', data.data, data.stats)
      } else {
        console.error('Admin Payout API - Error:', data.error)
        toast({
          title: "Error",
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight">Payout Management</h1>
        ...
        <div className="flex flex-col gap-2 sm:flex-row">
          <div className="flex gap-2">
            <Button variant="outline" onClick={loadPayouts} disabled={isLoading} size="sm" className="text-xs md:text-sm">
            ...
            {payouts.length > 0 && (
              <ExportDropdown
                ...
                filename="payout-management-report"
          ...
          <div className="flex gap-2">
            ...
            <Button onClick={() => setIsCreateDialogOpen(true)} size="sm" className="text-xs md:text-sm">
