...
const config: Config = {
  ...
  theme: {
    ...
    fontFamily: {
      ...
      'brand': ['Montserrat', 'Inter', '-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'Roboto', 'sans-serif'],
      ...
      animation: {
        ...
        "gradient-word": "gradientShift 3s ease-in-out infinite",
        "gradient-flow": "gradientFlow 2s ease-in-out infinite",
        "gradient-manage": "gradientFlow 2s ease-in-out infinite",
        "gradient-monetize": "gradientFlow 2s ease-in-out infinite 0.6s",
        "gradient-scale": "gradientFlow 2s ease-in-out infinite 1.2s",
      },
    },
  },
